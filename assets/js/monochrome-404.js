...
$(window).load(function() {
    ...
    (function() {
        ...
        MESSAGES.push({
            delay: 1200,
            text: 'Você pode ter digitado a URL incorretamente.'
        });
        MESSAGES.push({
            delay: 2200,
            text: 'Ou a página pode ter sido removida.'
        });
        MESSAGES.push({
            delay: 3600,
            text: 'Na verdade, não há nada para ver aqui...'
        });
        MESSAGES.push({
            delay: 5200,
            text: 'Clique nos links abaixo para fazer algo, Obrigado!'
        });
        $container = $('#container');
        $message = $('#message');
        $animate = $('#animate');
